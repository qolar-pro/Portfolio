...
const mk: Article[] = [
  ...
  },
  {
    ...
    excerpt:
      'За излогот се расправаат сите. Она што одлучува дали продавницата работи стои одзади: плаќања, залиха по варијанта, admin панел и брзина на среден телефон.',
    date: '2026-08-05',
    readingTime: '8 мин',
    tag: 'Е-трговија',
    body: [
